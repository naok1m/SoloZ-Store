...
export default function CartItem({ item }) {
  ...
  return (
    <div className="flex items-center gap-4 bg-db-card border border-db-border rounded-xl p-4 hover:border-sky-500/20 transition-colors">
      ...
      <div className="flex items-center gap-2 flex-shrink-0">
        <button
          ...
          className="w-7 h-7 bg-db-border rounded-lg text-white hover:bg-sky-500/20 hover:text-sky-400 transition-all text-sm font-bold flex items-center justify-center"
